...
class Client:
	...
	def sendRtspRequest(self, requestCode):
		...
		if requestCode == self.SETUP and self.state == self.INIT:
			...
			# 在 sendRtspRequest 方法中
			self.rtspSocket.send(request.encode()) # 將 request 轉換為 bytes-like 對象 #***************************
	...
	def openRtpPort(self):
		...
		try:
			...
			tkinter.messagebox.messagebox.showwarning('Connection Failed', 'Connection to rtpServer failed...')
